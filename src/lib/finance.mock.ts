...
export const FINANCE_SNAPSHOTS: Record<FinancePeriod, FinanceSnapshot> = {
  today: {
    ...
    popularDishes: [
      { name: "Quentinha M", orders: 26, units: 31, sales: 1240, share: 25 },
      { name: "Quentinha G", orders: 22, units: 25, sales: 1072.5, share: 21 },
      { name: "Quentinha GG", orders: 18, units: 20, sales: 918, share: 18 },
      { name: "Salada colorida na maionese", orders: 14, units: 16, sales: 734.4, share: 15 },
      { name: "Refrigerante 2 litros", orders: 11, units: 12, sales: 550.8, share: 11 },
    ],
  },
  "7d": {
    ...
    popularDishes: [
      { name: "Quentinha M", orders: 138, units: 166, sales: 6640, share: 24 },
      { name: "Quentinha G", orders: 116, units: 133, sales: 5700, share: 21 },
      { name: "Quentinha GG", orders: 94, units: 105, sales: 4820, share: 17 },
      { name: "Salada colorida na maionese", orders: 76, units: 88, sales: 4040, share: 14 },
      { name: "Refrigerante 2 litros", orders: 61, units: 68, sales: 3120, share: 11 },
    ],
  },
  "30d": {
    ...
    popularDishes: [
      { name: "Quentinha M", orders: 540, units: 668, sales: 26720, share: 24 },
      { name: "Quentinha G", orders: 468, units: 532, sales: 22950, share: 21 },
      { name: "Quentinha GG", orders: 382, units: 429, sales: 19680, share: 17 },
      { name: "Salada colorida na maionese", orders: 312, units: 365, sales: 16790, share: 15 },
      { name: "Refrigerante 2 litros", orders: 258, units: 291, sales: 13320, share: 12 },
    ],
  },
};
